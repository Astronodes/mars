...
class User extends AstroNodes
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('userRole', 'in', 'range' =>array('admin', 'member'), 'allowEmpty'=>false),
			array('email', 'email'),
			array('password_repeat, userRole', 'safe'),
	...
	{
		return CHtml::listData(Yii::app()->authManager->getRoles($this->id), "name", "name");
	}
